...
define ds389::site (
  ...
  $schema_install        = [ ], # array of ldif schema extensions to install from those included with module. One or more of:  'eduorg.ldif', 'sshlpk.ldif', 'edumember.ldif', 'nfsv4.ldif', 'voperson.ldif'
